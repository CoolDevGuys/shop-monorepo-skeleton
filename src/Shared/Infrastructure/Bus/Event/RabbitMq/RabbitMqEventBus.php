...
namespace CoolDevGuys\Shared\Infrastructure\Bus\Event\RabbitMq;

use AMQPException;
use CoolDevGuys\Shared\Domain\Bus\Event\DomainEvent;
use CoolDevGuys\Shared\Domain\Bus\Event\EventBus;
use CoolDevGuys\Shared\Infrastructure\Bus\Event\DomainEventJsonSerializer;
use CoolDevGuys\Shared\Infrastructure\Bus\Event\MySql\MySqlDoctrineEventBus;
